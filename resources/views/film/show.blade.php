                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div
                                ...
                                data-setbg="{{asset('img/'.$film->poster)}}"
                            >
                                <div class="comment">
                                ...
                                <div class="anime__details__widget">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <ul>
                                                <li>
                                                    <span>Scores:</span> 7.31 /
                                                    1,515
                                                </li>
                                                <li>
                                                    <span>Rating:</span> 8.5 /
                                                    161 times
                                                </li>
                                                <li>
                                                    <span>Duration:</span> 24
                                                    min/ep
                                                </li>
                                                <li>
                        ...
                        <div class="anime__details__review">
                            ...
                            <div class="anime__review__item">
                                ...
                                <div class="anime__review__item__text">
                                    ...
                                    <p>
                                        whachikan Just noticed that someone
                                        categorized this as belonging to the
                                        genre "demons" LOL
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="anime__review__item">
                                ...
                                <div class="anime__review__item__text">
                                    ...
                                    <p>
                                        Where is the episode 15 ? Slow update!
                                        Tch
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="anime__details__sidebar">
                            ...
                            >
                                ...
                                <h5>
                                    <a href="#"
                                        >The Seven Deadly Sins: Wrath of the
                                        Gods</a
                                    >
                                </h5>
                            </div>
